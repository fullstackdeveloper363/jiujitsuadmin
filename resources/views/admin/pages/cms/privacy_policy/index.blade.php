...
@section('title','Privacy | Jiu Jitsu')
...
@section('custom-script')
    ...
    <script>
        ...
        $('#addPrivacyPolicy').on('submit', function (e) {
            ...
            $.ajax({
                type: "POST",
                url: "{{ route('add_privacy_policy_request') }}",
                dataType: 'json',
                contentType: false,
                processData: false,
                cache: false,
        ...
        $('#editPrivacyPolicy').on('submit', function (e) {
            ...
            $.ajax({
                type: "POST",
                url: "{{ route('edit_privacy_policy_request') }}",
                dataType: 'json',
                contentType: false,
                processData: false,
                cache: false,
        ...
        $('#deletePrivacyPolicy').on('submit', function (e) {
            ...
            $.ajax({
                type: "POST",
                url: "{{ route('delete_privacy_policy_request') }}",
                dataType: 'json',
                contentType: false,
                processData: false,
                cache: false,
        ...
        function change_status(id, value) {
            ...
            $.ajax({
                type: "POST",
                url: "{{ route('update_privacy_policy_status') }}",
                dataType: 'json',
                data: {
                    id: id,
                    value: value,
