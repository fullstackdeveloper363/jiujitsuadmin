...
@section('title','Sub Assessment | Jiu Jitsu')
...
@section('custom-script')
    ...
    <script>
        ...
        $('#addSubCategory').on('submit', function (e) {
            ...
            $.ajax({
                type: "POST",
                url: "{{ route('add_sub_assessment_request') }}",
                dataType: 'json',
                contentType: false,
                processData: false,
                cache: false,
        ...
        function change_status(id, value) {
            ...
            $.ajax({
                type: "POST",
                url: "{{ route('update_sub_assessment_status_request') }}",
                dataType: 'json',
                data: {
                    id: id,
                    value: value,
        ...
        $('#deleteSubCategory').on('submit', function (e) {
            ...
            $.ajax({
                type: "POST",
                url: "{{ route('delete_sub_assessment_request') }}",
                dataType: 'json',
                contentType: false,
                processData: false,
                cache: false,
        ...
        $('#editSubCategory').on('submit', function (e) {
            ...
            $.ajax({
                type: "POST",
                url: "{{ route('edit_sub_assessment_request') }}",
                dataType: 'json',
                contentType: false,
                processData: false,
                cache: false,
