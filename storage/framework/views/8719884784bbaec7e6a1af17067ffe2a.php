<?php $__env->startSection('title','Assessment Level 2 | Jiu Jitsu'); ?>
                            ...
                            <div class="col-lg-12">
                                <div class="mb-3">
                                    ...
                                    <select  class="form-control" name="sub_assessments" id="category">
                                        ...
                                        <?php $__currentLoopData = $sub_assessment; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php $__env->startSection('custom-script'); ?>
    <script>
        ...
        $('#addChildAssessment').on('submit', function (e) {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo e(route('add_child_assessment_request')); ?>",
                dataType: 'json',
                contentType: false,
                processData: false,
                cache: false,
        ...
        function change_status(id, value) {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo e(route('update_child_assessment_status_request')); ?>",
                dataType: 'json',
                data: {
                    id: id,
                    value: value,
        ...
        $('#deleteSubCategory').on('submit', function (e) {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo e(route('delete_child_assessment_request')); ?>",
                dataType: 'json',
                contentType: false,
                processData: false,
                cache: false,
        ...
        function editRecord(id)
        {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo e(route('fetch_child_assessment_data')); ?>",
                dataType: 'json',
                data: {
                    id: id,
                    _token : "<?php echo e(csrf_token()); ?>"
                ...
                success: function (res) {
                    if (res.success === true) {
                        ...
                        let video_path = "<?php echo e(asset('video')); ?>".replace('video', data.video);
                        videoDiv.append('<video src="'+video_path+'" width="200" height="200" controls autoplay/>');
                        $('#edit_child_assessment_status').val(data.status);
                        let image_path = "<?php echo e(asset('image')); ?>".replace('image',data.thumbnail);
        ...
        $('#editChildAssessment').on('submit', function (e) {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo e(route('edit_child_assessment_request')); ?>",
                dataType: 'json',
                contentType: false,
                processData: false,
                cache: false,
        ...
        $(document).ready(function () {
            $("#assessment2").DataTable({
                ...
                "ajax": {
                    "url": "<?php echo e(route('get.assessment_level_2')); ?>",
                    "type": "POST",
                    data: {
                        "_token": "<?php echo e(csrf_token()); ?>",
                    }
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/apibeckdemo/public_html/jitsu/resources/views/admin/pages/content_management/assessment_L2/index.blade.php ENDPATH**/ ?>