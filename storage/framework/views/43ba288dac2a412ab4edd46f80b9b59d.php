                    ...
                    <div class="card-body pt-0">
                        <div class="auth-logo">
                            ...
                            <a href="avascript:void(0)" class="auth-logo-dark">
                                <div class="avatar-md profile-user-wid mb-4">
                                            <span class="avatar-title rounded-circle bg-light">
                                                <img src="<?php echo e(asset('assets/images/logo.svg')); ?>" alt="" class="rounded-circle" height="34">
                                            </span>
                                </div>
                            </a>
                        </div>
...
<script>
    ...
    $("#loginForm").on('submit', function (e) {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo e(route('login_request')); ?>",
            dataType: 'json',
            contentType: false,
            processData: false,
            cache: false,
...
<?php /**PATH /home/apibeckdemo/public_html/jitsu/resources/views/admin/pages/login.blade.php ENDPATH**/ ?>