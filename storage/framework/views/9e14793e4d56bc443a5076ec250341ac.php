<?php $__env->startSection('title','Term & Condition | Jiu Jitsu'); ?>
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered mb-0">
                            ...
                            <tbody>
                            <?php if($term_condition->count() > 0): ?>
                                <?php $__currentLoopData = $term_condition; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
...
<?php $__env->startSection('custom-script'); ?>
    ...
    <script>
        ...
        $('#addTermCondition').on('submit', function (e) {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo e(route('add_term_condition_request')); ?>",
                dataType: 'json',
                contentType: false,
                processData: false,
                cache: false,
        ...
        $('#editPrivacyPolicy').on('submit', function (e) {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo e(route('edit_term_condition_request')); ?>",
                dataType: 'json',
                contentType: false,
                processData: false,
                cache: false,
        ...
        $('#deletePrivacyPolicy').on('submit', function (e) {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo e(route('delete_term_condition_request')); ?>",
                dataType: 'json',
                contentType: false,
                processData: false,
                cache: false,
        ...
        function change_status(id, value) {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo e(route('update_term_condition_status')); ?>",
                dataType: 'json',
                data: {
                    id: id,
                    value: value,
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/apibeckdemo/public_html/jitsu/resources/views/admin/pages/cms/terms_and_condition/index.blade.php ENDPATH**/ ?>