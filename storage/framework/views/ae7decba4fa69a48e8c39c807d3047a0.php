<?php $__env->startSection('title','Main Assessment | Jiu Jitsu'); ?>
...
<?php $__env->startSection('custom-script'); ?>
    <script>
        $('#addMainCategory').on('submit', function (e) {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo e(route('add_main_assessment_request')); ?>",
                dataType: 'json',
                contentType: false,
                processData: false,
                cache: false,
        ...
        function change_status(id, value) {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo e(route('update_main_assessment_status')); ?>",
                dataType: 'json',
                data: {
                    id: id,
                    value: value,
        ...
        function editRecord(id,title,thumbnail,status,type,or_no)
        {
            ...
            $('.display').html('');
            let thumbnail_path = "<?php echo e(asset('image')); ?>".replace('image',thumbnail);
        ...
        $('#editMainCategory').on('submit', function (e) {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo e(route('edit_main_assessment_request')); ?>",
                dataType: 'json',
                contentType: false,
                processData: false,
                cache: false,
        ...
        $('#deleteMainCategory').on('submit', function (e) {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo e(route('delete_main_assessment_request')); ?>",
                dataType: 'json',
                contentType: false,
                processData: false,
                cache: false,
        ...
        $(document).ready(function () {
            $("#mainAssessment").DataTable({
                ...
                "ajax": {
                    "url": "<?php echo e(route('get.assessment')); ?>",
                    "type": "POST",
                    data: {
                        "_token": "<?php echo e(csrf_token()); ?>",
                    }
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/apibeckdemo/public_html/jitsu/resources/views/admin/pages/content_management/assessments/main_assessment.blade.php ENDPATH**/ ?>